...
- [更完整的本地模型网关](docs/chatgpt-local-auth.zh-CN.md)：支持通过 OpenAI-compatible 本地代理使用 **OpenAI 订阅账号**，在多次 Activation 之间保持 Project Owner 上下文与 Cache Affinity，并将网关超时和异常沉淀为明确的 Runtime 证据。
