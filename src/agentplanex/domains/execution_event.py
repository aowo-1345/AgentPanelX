...
class ExecutionEventType(StrEnum):
    ...
    OWNER_ACTIVATION_FAILED = "OWNER_ACTIVATION_FAILED"
    ...
    AUTO_TAKEOVER_STARTED = "AUTO_TAKEOVER_STARTED"
    AUTO_TAKEOVER_COMPLETED = "AUTO_TAKEOVER_COMPLETED"
    AUTO_TAKEOVER_FAILED = "AUTO_TAKEOVER_FAILED"
    ...
    FIRST_RUN_APPROVAL_REJECTED = "FIRST_RUN_APPROVAL_REJECTED"
    BLOCKED_RUN_APPROVAL_REQUESTED = "BLOCKED_RUN_APPROVAL_REQUESTED"
    BLOCKED_RUN_APPROVED = "BLOCKED_RUN_APPROVED"
    BLOCKED_RUN_REJECTED = "BLOCKED_RUN_REJECTED"
...
class RuntimeContextChangeReason(StrEnum):
    ...
    OWNER_ACTIVATION_FAILED = "OWNER_ACTIVATION_FAILED"
    INTERRUPTED_WORK_FAILED = "INTERRUPTED_WORK_FAILED"
    USER_INTERVENTION_REQUIRED = "USER_INTERVENTION_REQUIRED"
    PLAN_APPROVAL_REQUESTED = "PLAN_APPROVAL_REQUESTED"
    PLAN_APPROVED = "PLAN_APPROVED"
    PLAN_REJECTED = "PLAN_REJECTED"
    MILESTONES_UPDATED = "MILESTONES_UPDATED"
    MILESTONE_HARD_GATE_REJECTED = "MILESTONE_HARD_GATE_REJECTED"
    FIRST_RUN_APPROVAL_REQUESTED = "FIRST_RUN_APPROVAL_REQUESTED"
    FIRST_RUN_APPROVAL_REJECTED = "FIRST_RUN_APPROVAL_REJECTED"
    BLOCKED_RUN_APPROVAL_REQUESTED = "BLOCKED_RUN_APPROVAL_REQUESTED"
    BLOCKED_RUN_REJECTED = "BLOCKED_RUN_REJECTED"
